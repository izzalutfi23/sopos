...
@section('title', 'Diskon - Online Poin of Sales')
@section('container')
<div class="page-wrapper">
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Diskon</h4>
                        <span>Halaman untuk mengatur diskon pembelian</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Diskon</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="alert alert-success background-danger">
        ...
        <strong>Perhatian!</strong> {{session('ada')}}
    </div>
    @endif
    <!-- Cek End -->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{url('/dashboard/diskon')}}" method="post"
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input name="minimal" type="number"
                                                                    class=" form-control" required="required">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <label class="block">Jumlah Diskon</label>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <input name="jml_diskon" type="number"
                                                                    class=" form-control" required="required">
                                                            </div>
                                                        </div>
                                                    </fieldset>
                            ...
                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp {{number_format($data->jml_diskon)}}</td>
                                        <td align="center">
                                            <a href="{{url('/dashboard/diskon/'.$data->id)}}" class="sweet-1"><button
